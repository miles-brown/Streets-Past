...
### Edge Functions (Deno)
- `suggest-etymology`: Pattern-matching etymology engine with 80+ linguistic patterns covering Old English, Old Norse, Norman French, Latin origins
- `create-bucket-historical-maps-temp`: One-time storage setup function
...
| `street-etymology/src/App.tsx` | All route definitions |
...
| `supabase/functions/suggest-etymology/index.ts` | Etymology pattern matching engine |
